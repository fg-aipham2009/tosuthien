export const DEFAULT_TOP_K = 28;
export const LOOKUP_TOP_K = 20;
export const DEFINITION_TOP_K = 32;
export const COMPARISON_TOP_K = 32;
export const MAX_TOP_K = 44;
/** Candidate pool before filtering/ranking (recall > precision here). */
export const CANDIDATE_POOL = 144;
