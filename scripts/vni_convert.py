...
class Converter:
    ...
    """Convert between legacy Vietnamese charsets (VNI, TCVN3, etc.)."""
...
def to_unicode(text: str, source=None) -> str:
    conv = Converter()
    src = source or conv.detectCharset(text)
    if src and src != "UNICODE":
        return conv.convert(text, "UNICODE", src)
    return text
