(function () {
  ...
  function showBanner() {
    ...
    bar.style.cssText =
      ...
      "padding:12px 14px;border-radius:14px;background:#612200;color:#F7F2F0;" +
    ...
    install.style.cssText =
      "border:0;border-radius:999px;background:#F7F2F0;color:#612200;padding:8px 14px;cursor:pointer;font:600 13px system-ui,sans-serif";
